				...
				<div class="card-body">
					<form class="p-3" action="{{ route('client.store') }}" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="email" id="clientEmail" name="clientEmail"  class="form-control {{ $errors->has('clientEmail') ? ' is-invalid' : '' }}" required placeholder="john@example.com" value="{{ old('clientEmail') }}">
						...
						<div class="form-group">
							...
							<input type="text" id="clientPhone" name="clientPhone"  class="form-control {{ $errors->has('clientPhone') ? ' is-invalid' : '' }}"  placeholder="+880 1754218741" value="{{ old('clientPhone') }}">
						...
						<div class="form-group">
							...
							<input type="text" id="address" name="address"  class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}"  placeholder="Mirpur-10, Benarossi Polli">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									...
									<input type="text" class="form-control {{ $errors->has('address') ? ' is-invalid' : '' }}" placeholder="Dhaka" name="city" value="{{ old('city') }}">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<input type="text" class="form-control" placeholder="Client State / Province / Region" name="state" value="{{ old('state') }}">
								...
								<div class="col-md-6">
									...
									<input type="text" class="form-control {{ $errors->has('postalCode') ? ' is-invalid' : '' }}" placeholder="Postal / Zip Code" name="postalCode" value="{{ old('postalCode') }}">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									...
									<input type="text" id="companyName" name="companyName"  class="form-control {{ $errors->has('companyName') ? ' is-invalid' : '' }}"  placeholder="Codeshaper" value="{{ old('companyName') }}">
								...
								<div class="col-md-6">
									...
									<input type="text" id="taxID" name="taxID"  class="form-control {{ $errors->has('taxID') ? ' is-invalid' : '' }}" placeholder="Tax ID" value="{{ old('taxID') }}">
						...
						<div class="form-group">
							...
							<input type="password" id="password" name="password"  class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}"  placeholder="******" value="{{ old('password') }}" required>
